  ...
  return (
    <div className="flex flex-col h-full bg-neutral-950 text-neutral-100 font-sans selection:bg-orange-500/30">
      <header className="flex items-center justify-between px-6 py-4 border-b border-neutral-800 bg-black/60 backdrop-blur-md shrink-0">
        ...
        <div className="ml-auto"><span className="text-[10px] font-mono text-green-500 tracking-[0.2em] font-bold">A Raja Sandhu Project v3.5.0</span></div>
      </header>
      ...
      <footer className="px-6 py-1 border-t border-neutral-800 flex items-center justify-between bg-neutral-950 text-[8px] uppercase text-neutral-600 font-mono"><span>MIDI: ACTIVE SYNC: INTERNAL</span><span className="text-green-900/60">A Raja Sandhu Project v3.5.0</span></footer>
    </div>
  );
}
